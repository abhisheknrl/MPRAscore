...
struct Table_SortItem
{
	...
	double m_fValue; // For numerical sorts
	int m_nIndex;
};
*/
...
struct Table_SortItem_int
{
	CString m_sKey; // For string-based sorts
	int m_Value; // For numerical sorts
	int m_nIndex;
};
...
#endif
// Table_GetdoubleAt has been replaced by:
...
bool Table_Resort_double(const CTableIndex &ti, CVector<Table_SortItem_double> vSI);
